...
class NetSniffer(object):
    ...
    def __init__(self, debug_mode, monitor_system, project_name, pattern_parser, interface, patron_filtro, custome_filters='', solo_resumen=True):
        '''
        Constructor
        '''
        ...
        self.filtro_patron = patron_filtro
    ...
    def comenzar(self):
        ...
        print('    => Patron aplicado: ' + str(self.filtro_patron))
        print('-----------------------------------------')
        self.__init_capture()
